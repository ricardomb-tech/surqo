...
const cards: RuixenCardProps[] = [
  {
    ...
    subtitle: 'Nodos ESP32 con lecturas cada 15 minutos vía MQTT TLS',
    image: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=600&q=80',
    badge: { text: 'IoT', variant: 'indigo' },
    href: '/soluciones',
  },
  {
    title: 'Análisis agronómico con IA',
    subtitle: 'Llama 3.3 70B genera recomendaciones en español claro',
  ...
  },
  {
    ...
    subtitle: 'Detecta estrés hídrico y condiciones críticas a tiempo',
  ...
  },
  {
    ...
    subtitle: 'KPIs en tiempo real desde cualquier dispositivo',
    image: 'https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=600&q=80',
    badge: { text: 'Panel', variant: 'indigo' },
    href: '/soluciones',
  },
  {
    title: 'Conecta tu finca hoy',
    subtitle: 'Empieza gratis y monitorea tu cultivo en minutos',
    image: 'https://images.unsplash.com/photo-1595872729893-6af3e84f3f69?w=600&q=80',
    badge: { text: 'Gratis', variant: 'orange' },
    href: '/register',
  },
];
  ...
  useEffect(() => {
    cardRefs.current.forEach((card, i) => {
      ...
      if (Math.abs(position) > 2) {
        ...
        gsap.to(card, { x, y, scale, duration: 0.6, ease: 'power2.out' });
      }
    });
  }, [currentIndex]);
              ...
              >
                ...
                <div className="absolute bottom-4 left-4 right-4 group-hover:scale-[1.01] group-hover:translate-y-[-4px] transform transition-all duration-300 ease-out bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md rounded-xl p-4 shadow-md border border-white/10 dark:border-zinc-700">
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm text-zinc-600 dark:text-zinc-300 leading-snug">{card.subtitle}</p>
