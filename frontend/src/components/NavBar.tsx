...
import { Zap, LayoutDashboard, Activity, Bell, FlaskConical, Sprout, Menu, X, LogOut, ChevronDown } from "lucide-react"
...
export function NavBar() {
  ...
  return (
    <nav className="fixed top-0 inset-x-0 z-50 border-b border-slate-200 bg-white/90 backdrop-blur-xl shadow-sm">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2 shrink-0 group">
          <Zap className="w-5 h-5 text-surqo-green transition-colors" />
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="md:hidden p-2 rounded-xl text-surqo-text-secondary hover:text-surqo-text hover:bg-slate-100 transition-all"
          >
